    ...
    <div className="instructions-page">
      <div className="instructions-container">
        ...
        <div className="instructions-content">
          ...
          <p>I have created this app to help both myself and others to engage in scripture memory in an easy and fun way. I began with a cryptogram game, and am working to add additional tranlations, games, user stats, and other </p>    
          ...
          <h2>Practical Tips for Memorization</h2>
          <ul>
            <li><strong>Memorize wtih context</strong>: Try memorizing an entire passage rather than individual verses</li>
            <li><strong>Repeat Regularly</strong>: Review at the intervals</li>
